    ...
    <body>
        ...
        <div class="myDiv">
            <h1 style="padding:30px; margin:0; color: #456">
                Bölgü Edəcəyiniz Növbəni Seçin
            </h1>
            <div style="height: auto; width: 40%; margin: auto;">
                <a href="division?shift=1" class="btn btn-primary links">I Növbə</a>
                <a href="division?shift=2" class="btn btn-primary links" >II Növbə</a>
                <a href="division?shift=3" class="btn btn-primary links" >III Növbə</a>
            </div>
        </div>
        <div class="footerDiv">
            <font class="info">
