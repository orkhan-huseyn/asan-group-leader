...
<html>
    ...
    <body>
        <div class="headerDiv">
            ...
            <a href="welcome" class="btn btn-primary back" style="float:left; margin: 100px 0 0 6px;">Geri</a>
        </div>
        <div class="myDiv">
            <h1 style="padding:30px; margin:0; color: #456">Siyahısını Görüntüləcəyiniz Növbəni Seçin</h1>
            <div style="height: auto; width: 40%; margin: auto;">
                <a href="lists/listVolunteers?shift=1" class="btn btn-primary links">I Növbə</a>
                <a href="lists/listVolunteers?shift=2" class="btn btn-primary links" >II Növbə</a>
                <a href="lists/listVolunteers?shift=3" class="btn btn-primary links" >III Növbə</a>
            </div>
        </div>
        <div class="footerDiv">
            <font class="info">
